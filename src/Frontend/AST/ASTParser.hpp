...
struct Declaration {
    ...
    enum class StorageClass : u8 {
        AutoLocalScope, GlobalScopeDeclaration, StaticGlobalTentative,
        StaticGlobalInitialized, StaticLocal, StaticLocalFunction,
        ExternFunction, ExternLocal, ExternGlobal, ExternGlobalInitialized,
        GlobalDefinition,
    };
    Kind kind;
