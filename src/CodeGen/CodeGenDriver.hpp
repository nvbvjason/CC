...
namespace CodeGen {
    ...
    void run(const Ir::Program& irProgram, const std::string& argument);
    ...
    void writeAsmFile(const std::string& inputFile, std::string& output, const std::string& outputFileName);
